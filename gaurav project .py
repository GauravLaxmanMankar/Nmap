...
def startScan():
    ...
    log.append('> Scanned Ports report')
    log.append('='*14 + '\n')
...
# ==== Labels ====
L11 = Label(gui, text = "NetMap ",  font=("Helvetica", 16, 'underline'))
L11.place(x = 16, y = 10)
 
L21 = Label(gui, text = "Target: ")
L21.place(x = 16, y = 90)
 
L22 = Entry(gui, text = "IP or website name")
L22.place(x = 180, y = 90)
L22.insert(0, "Ip or website name")
